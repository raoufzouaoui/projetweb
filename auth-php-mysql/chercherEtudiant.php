      ...
      <a class="navbar-brand" href="index.php">SCO-Enicar</a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          ...
          <form methode="GET" action="chercherGroupe.php"  class="form-inline my-2 my-lg-0">
              <input  type="search" name="s" placeholder="Saisir un groupe" aria-label="Chercher un groupe" id="search" autocomplete="off">
...
<main role="main">
        <div class="jumbotron">
            <div class="container">
                ...
                <br>
                <h1><?= $bienvenue ?></h1>
              <h5 class="display-4">Chercher tous les étudiants</h5>
...
<div class="table-responsive"> 
    ...
    <form methode="GET" action="">
        <input class="form-control mr-sm-2" type="search" name="e" placeholder="chercher etudiant" id="searchET" autocomplete="off">
 ...
 <div id="searchresult"></div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#searchET").keyup(function(){
                
                var input =$(this).val(); // afficher dans l'alert l'input
                    //alert(input);
                if(input != "" && input!="'"){
                    $.ajax({
                    ...
                    document.getElementById('searchresult').innerHTML ="<div style='font-size:20px; text-align:center margin-top:10px'>Aucun etudiant trouvé</div>"
                }
            });
        });
    </script>
