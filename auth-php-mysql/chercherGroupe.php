<?php
   ...
   if($_SESSION["autoriser"]!="oui"){
    ...
    if(isset($_GET['s']) AND !empty($_GET['s'])) //Determine if a variable is declared and is different than NULL
    {
        $recherche= htmlspecialchars($_GET['s']); //Convert special characters to HTML entities
        $allGroups=$pdo->query("SELECT * FROM etudiant WHERE Classe LIKE '%".$recherche."%'");
...
<main role="main">
        <div class="jumbotron">
            <div class="container">
                ...
                <br>
                <h1><?= $bienvenue ?></h1>
              <h5 class="display-4">Chercher tous les Groupes</h5>
