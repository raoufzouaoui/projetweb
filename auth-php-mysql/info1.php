<?php
   ...
   if($_SESSION["autoriser"]!="oui"){
      ...
      exit();
       ...
       $query="SELECT * FROM `etudiant` WHERE Classe in(select Classe from `enseignant_classe` where Classe LIKE 'INFO1%'AND id_ense in (select id from enseignant where login='$login'))" ;
...
<main role="main">
        <div class="jumbotron">
            <div class="container">
                ...
                <br>
                <h1><?= $bienvenue ?></h1>
              <h5 class="display-4">Mes etudiants INFO1 </h5>
