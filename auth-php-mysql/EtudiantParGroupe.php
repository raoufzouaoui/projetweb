...
<main role="main">
        <div class="jumbotron">
            <div class="container">
              ...
              <h5 class="display-4">afficher tous les étudiants par groupe</h5>
         ...
         $.get(
            ...
            function(data){
               ...
               $('#slct').change(function(){
                  chargerEtudiant($(this).val());

               });
                  });
                }
                
function chargerEtudiant(classe){
         $.get("EtudParGrp.php?code="+classe,
         function(data){
            $('#tabEtud').html(data);  
            });
            }
